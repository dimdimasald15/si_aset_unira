...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2023 at 05:43 PM
...
CREATE TABLE `barang` (
  ...
  `tindakan_kerusakan` varchar(20) DEFAULT NULL,
...
(13, '2023-03-14-120823', 'App\\Database\\Migrations\\Satuan', 'default', 'App', 1678797884, 3),
(14, '2023-03-14-120843', 'App\\Database\\Migrations\\Barang', 'default', 'App', 1678797935, 4);
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `barang_kat_id_foreign` FOREIGN KEY (`kat_id`) REFERENCES `kategori` (`id`),
  ADD CONSTRAINT `barang_ruang_id_foreign` FOREIGN KEY (`ruang_id`) REFERENCES `ruang` (`id`),
