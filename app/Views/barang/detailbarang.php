  ...
  <div class="main-content">
    <div class="header bg-success pt-4 pb-5 py-lg-4">
      <div class="container">
        ...
        <?php if ($barang) { ?>
          <div class="row justify-content-center">
            <div class="col-lg-9 col-md-9 col-12" id="biodata">
                    ...
                    <div class="col-lg-12">
                      <div class="table-responsive">
                        <table class="table table-responsive-sm table-borderless ">
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Kode Barang</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?= $barang->kode_brg ?></td>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Kategori Barang</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?= $barang->nama_kategori ?></td>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Jumlah Barang</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?= $barang->jumlah_sisa_stok . ' ' . $barang->kd_satuan ?></td>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Lokasi Barang</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?= $barang->nama_ruang ?></td>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row" colspan="3">Deskripsi Barang</th>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Asal Barang</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <?php if ($barang->toko) { ?>
                          ...
                          <?php if ($barang->no_seri !== "" && $barang->no_dokumen !== "" && $barang->no_seri !== null && $barang->no_dokumen !== null) { ?>
                            <tr>
                              <th class="table-light" style="max-width:150px;" scope="row">Nomor Seri</th>
                              <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                              <td><?= $barang->no_seri ?></td>
                            </tr>
                            <tr>
                              <th class="table-light" style="max-width:150px;" scope="row">Nomor Dokumen</th>
                              <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                              <td><?= $barang->no_dokumen ?></td>
                            </tr>
                          <?php } else '' ?>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Merk</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?= $barang->merk ?></td>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Warna</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?= $barang->warna ?></td>
                          </tr>
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Harga Beli</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?php
                          ...
                          <tr>
                            <th class="table-light" style="max-width:150px;" scope="row">Harga Jual</th>
                            <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                            <td><?php
                          ...
                          <?php if ($barang->updated_at !== null) { ?>
                            <tr>
                              <th class="table-light" style="max-width:150px;" scope="row">Updated at</th>
                              <td class="table-light" style="width:10px"> <strong>:</strong> </td>
                          ...
                          <?php } else { ?>
                            <tr>
                              <th class="table-light" style="max-width:150px;" scope="row">Created at</th>
                              <td class="table-light" style="width:10px"> <strong>:</strong> </td>
