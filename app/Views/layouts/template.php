...
<head>
    ...
    <!--  Social tags      -->
    <meta name="keywords"
        content="sistem informasi, manajemen aset, labelling assets, qr code, perguruan tinggi, UNIRA, malang, universitas">
    ...
    <link rel="stylesheet"
        href="<?= base_url() ?>assets/vendors/DataTables/DataTables-1.13.3/css/dataTables.jqueryui.css">
    <!-- sweetalert2 -->
    ...
    <!-- fontawesome -->
    <link href="<?= base_url() ?>assets/vendors/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet"
        type="text/css">
    ...
    <!-- module js -->
    <script type="module" src="<?= base_url() ?>assets/js/myscript/main.js" defer></script>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown me-1">
                                    <a class="nav-link active dropdown-toggle count" data-bs-toggle="button"
                                        id="pelaporanmasuk" aria-expanded="false">
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" id="showpelaporan"
                                        aria-labelledby="pelaporanmasuk"></ul>
                                </li>
                                <li class=" nav-item dropdown me-3">
                                    <a class="nav-link active dropdown-toggle notifpersediaan" id="notifpersediaan"
                                        href="#" data-bs-toggle="button" aria-expanded="false">
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" id="shownotif"
